...
description: >
  ...
  as bloom / panel / tile underprint, Instrument Serif display + Instrument Serif sans + Inconsolata data,
...
typography:
  # — reading + data ramp —
  body:    { fontFamily: "Inter", cqw: 0.85, weight: 400, lineHeight: 1.5, color: "ink" }
  body-lede:{ fontFamily: "Inter", cqw: 0.95, weight: 400, lineHeight: 1.55 }
  micro-label:{ fontFamily: "Inter", px: 13, weight: 600, tracking: "0.18em", upper: true }
  rail-label:{ fontFamily: "Inter", px: 13, weight: 600, tracking: "0.32em", upper: true }
  mono-data:{ fontFamily: "Inconsolata", cqw: 0.73, weight: 400, tracking: "0.04em" }
  pagenum: { fontFamily: "Inconsolata", px: 13, weight: 400, tracking: "0.08em", opacity: 0.75 }
...
- **Fonts** — already set to **Instrument Serif** (display) / **Inter** (body); ignore any preset font name lingering in prose.
...
negative tracking) carries every display, numeral, and quote from 40px to 720px+; **Instrument Serif** carries
body and the wide-tracked uppercase micro-label; **Inconsolata** carries every date, figure, and
...
- **Instrument Serif 400** display (tight, negative-tracked); **Instrument Serif** body + micro-labels; **Inconsolata** data.
...
Two ramps. The **reading/data ramp** (Instrument Serif body 0.85cqw ink, micro-labels in px, Inconsolata
...
- **Instrument Serif is weight 400 only** (its contrast is the weight signal), tight line-height (0.84–1.06), negative tracking; **micro-labels uppercase Instrument Serif 600, ≥0.16em**; **mono for all numerals/dates**. No bold serif, no second text color, no mono in body/display.
...
- Set every line in **ink**; use **Instrument Serif 400** (tight, negative-tracked) for display, **Instrument Serif** body, **Inconsolata** for all numerals/dates.
- Make every separator a **1px ink hairline** (soft variant for dense rows); flood a **yellow panel** for poster moments (ink on top).
- Keep micro-labels **uppercase Instrument Serif 600, 0.16–0.32em**; pin the **pagenum** bottom-right.
...
- **Instrument Serif + Instrument Serif + Inconsolata via Google Fonts.** CJK: Smiley Sans (display) / Noto Serif SC (body) / Noto Sans SC (labels); italic serif and mono tabular figures have no exact Hanzi equal — keep ledger dates Latin.
